...
function playGame(){
    ...
    let CC = computerChoice.toUpperCase(); 
      if (HC === "ROCK" && CC === "PAPER"){
        console.log( "%cYou lose this round! Paper beats Rock.","color: red;");
        return computerScore ++;
      } else if (HC === "PAPER" && CC === "SCISSORS"){
        console.log( "%cYou lose this round! Scissors beats Paper.","color: red;");
        return computerScore ++;
      } else if (HC === "SCISSORS" && CC === "ROCK"){
        console.log( "%cYou lose this round! Rock beats Scissors.","color: red;");
        return computerScore ++;
      } else if (CC === "ROCK" && HC === "PAPER"){
        console.log( "%cYou win this round! Paper beats Rock.","color: green; font-weight: bold;");
        return humanScore ++;
      } else if (CC === "PAPER" && HC === "SCISSORS"){
        console.log( "%cYou win this round! Scissors beats Paper.","color: green; font-weight: bold;");
        return humanScore ++;
      } else if (CC === "SCISSORS" && HC === "ROCK"){
        console.log( "%cYou win this round! Rock beats Scissors.","color: green; font-weight: bold;");
        return humanScore ++;
      } else if(CC === HC){
    ...
    if(computerScore > humanScore){
        ...
        console.log(`%cWinner: You with a total score of ${humanScore} while Computer lost with a score of ${computerScore}`,"color: green; font-weight: bolder;");
    } else if(computerScore === humanScore){
        console.log(`%cIt was a tie!, You both had a score of ${humanScore}!`,"color: brown;");
        userChoice;
    } 
}
